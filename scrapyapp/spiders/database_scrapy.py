...
import scrapy
import MySQLdb
from scrapyapp.pipelines import MySQLStorePipeline


class DatabaseScrapySpider(scrapy.Spider):
    name = 'database_scrapy'
    ...
    def getProductDetail(self, response):       
        ...
        obj = MySQLStorePipeline()
        obj.process_item(d, scrapy.Spider)
    ...
    #     try:
    #         self.connection = MySQLdb.connect(self.host, self.user, self.password, self.database, use_unicode=True, charset="utf8")
