...
class DownloadimagesScrapySpider(scrapy.Spider):
    name = 'downloadImages_scrapy'
    ...
    def after_login(self, response):
        ...
        item_url = "https://www.darice.com/store/browse/catalog/wholesale-jewelry-beads-acrylic-tri-beads"
        yield scrapy.Request(url=item_url, callback=self.getProductDetail)
