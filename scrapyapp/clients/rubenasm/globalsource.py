...
class GlobalSourceHelper():
    ...
    def getProducts(self):
        print "welcome to getProducts."
        products_url = []
        
        item_url = 'http://www.globalsources.com/gsol/I/all-manufacturers/b/2000000003844/3000000149681/-1.htm'
        print 'item_url : ',item_url
        self.driver.get(item_url)
        time.sleep(2)

        products = self.driver.find_elements_by_css_selector(".browse")
        print ("products : ",len(products))
        print('Order created successfully.')
        for product in products:
            product_url = product.find('a')['href']
            product_url = 'http://www.globalsources.com' + str(product_url)
    ...
    def start(self):
        ...
        print("Total items are : ",len(products))
        # if len(items) > 0:
...
if __name__ == "__main__":
    ...
    # objG is an instance for GlobalSourceHelper.
    objG = GlobalSourceHelper()
    objG.start()